# GitHub Copilot – GH-300 Training & Resources
...
### Lab Portal
https://gsi.learnondemand.net/Class/737816

**Training Key:** `692ED72A904A75EA`

### Access Steps

1. Navigate to:
   https://cloudthat.learnondemand.net/Class/738659

2. Sign in using:
   - Microsoft Account (Live ID), OR  
   - Entra ID  

3. Click **Redeem Training Key** at the top of the page.

4. Enter the training key and follow the prompts to access course materials.

---

# 🎥 Recording Access

## Course: Improve Developer Productivity with GitHub Copilot

### TestPrep URL
https://testprep.cloudthat.com/course/view.php?id=4526

**Enrollment Key:** `D2SREZ`
...
2. After login, go to **My Home** and complete your profile details.

3. Access the course using:
   https://testprep.cloudthat.com/course/view.php?id=4526
...
- Recordings will be uploaded within **24 hours** after session delivery.
- Recordings are available for **30 days**.
- Access is **view-only mode**.
...
## 1️⃣ Guided Project – Build Auto Suggest Engine with Copilot

https://learn.microsoft.com/en-us/training/modules/build-auto-suggest-engine-copilot/

---

## 2️⃣ Develop with AI-powered Code Suggestions

Module:
https://learn.microsoft.com/en-us/training/modules/introduction-to-github-copilot/5-exercise
...
## 3️⃣ Democratize Tribal Knowledge using Copilot Spaces

Module:
https://learn.microsoft.com/en-us/training/modules/introduction-copilot-spaces/4-skills-exercise
...
## 4️⃣ Develop Unit Tests using GitHub Copilot

Module:
https://learn.microsoft.com/en-us/training/modules/develop-unit-tests-using-github-copilot-tools/6-exercise-develop-unit-tests-github-copliot
...
## 5️⃣ GitHub Skills – Agent Mode

Module:
https://learn.microsoft.com/en-us/training/modules/github-copilot-agent-mode/4-exercise
...
## 6️⃣ Integrate MCP with GitHub Copilot

Module:
https://learn.microsoft.com/en-us/training/modules/mcp-server/5-exercise-integrate-github-copilot
